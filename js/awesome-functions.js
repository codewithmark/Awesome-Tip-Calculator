  ...
  api.UserLoc = function(UserElementObj) 
  {
    var LocDataArr = [];
   	var IPCheck = c.Get('LocIP');
		...
		if(IPCheck)
		{
			UserElementObj.append('<div class="LocStatus">'+c.Get('LocStatus')+'</div>');
			UserElementObj.append('<div class="LocIP">'+c.Get('LocIP') +'</div>');
			UserElementObj.append('<div class="LocCity">'+c.Get('LocCity') +'</div>');
			UserElementObj.append('<div class="LocState">'+c.Get('LocState')+'</div>');
			UserElementObj.append('<div class="LocZip">'+c.Get('LocZip')+'</div>');
			UserElementObj.append('<div class="LocCountry">'+c.Get('LocCountry') +'</div>');
			UserElementObj.append('<div class="LocLat">'+c.Get('LocLat') +'</div>');
			UserElementObj.append('<div class="LocLong">'+c.Get('LocLong')+'</div>');
			UserElementObj.append('<div class="LocTimeZone">'+c.Get('LocTimeZone') +'</div>');
...
//--->LocalStorage Functions - Start
  ...
  { 
    var Data = localStorage.setItem(LookUpIndexKey,Val);
    return Data;
  }

  ls.Get = function (LookUpIndexKey,Val) 
  { 
  ...
  */
  ...
  ls.GetArr = function(LookUpIndexKey,FieldName,WhereValueEquals)
  { 
  ...
  ls.EmptyArr = function (LookUpIndexKey) 
  { 
